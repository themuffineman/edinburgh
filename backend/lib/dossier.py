...
def generateCustomEmail(dossier:  dict[str, any]) -> Custom_Email:
    ...
    example_response= f""" "body":"Hey [decision maker's name], So am not sure if this will work for [business name] but I figured I’d reach out anyway. I built a tool that auto-generates a detailed SEO audit for any website you enter. { " It costs just a few cents to run, and I can see it easily helping convert more leads into paid clients with this as a lead magnet." if dossier["is_qualified"] == False else "It only costs a few cents to run. Since it runs almost instantly, you can free up your team to take on more clients."}\n \nI know it's a long shot but would you find someting like this useful? If yes I can get back to you in 30 mins or so with a link to the system. Do you want me to just go ahead and do it?\n \nLooking forward to hearing from you [decision maker name],\nPetrus", "subject":"Could this work for you too [decision maker name]?" """

    example_output=f""" "body":"Hey Darren, So am not sure if this will work for Maki but I figured I’d reach out anyway. I built a tool that auto-generates a detailed SEO audit for any website you enter. { " It costs just a few cents to run, and I can see it easily helping convert more leads into paid clients with this as a lead magnet." if dossier["is_qualified"] == False else "It only costs a few cents to run. Since it runs almost instantly, you can free up your team to take on more clients."}\n \nI know it's a long shot but would you find someting like this useful? If yes I can get back to you in 30 mins or so with a link to the system. Do you want me to just go ahead and do it?\n \nLooking forward to hearing from you Darren,\nPetrus", "subject":"Could this work for you too Darren?" """
    ...
    system_prompt = f"""
        ...
        ### Example:
        Input (summary):
        "Darren runs Maki SEO Consulting, an SEO agency focused on helping Local Businesses rank on google maps"
